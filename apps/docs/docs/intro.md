...
3. **Actionable Feedback**: Inline PR comments explain *what* violated the policy, *why* the standard exists, and *how* to refactor it, with direct links back to this documentation playbook.
