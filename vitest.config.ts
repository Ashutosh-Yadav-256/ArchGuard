...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@archstandards/github-adapter": path.resolve(__dirname, "packages/github-adapter/src/index.ts"),
    },
  },
  test: {
    globals: true,
    environment: "node",
    include: ["packages/*/tests/**/*.test.ts", "apps/*/tests/**/*.test.ts", "benchmarks/**/*.test.ts"],
    coverage: {
      provider: "v8",
